...
namespace utils::math::geometry::shape
	...
	struct polyline : utils::math::geometry::shape::details::polyline<polyline<ends>, ends>
		{
	...
	namespace view
		...
		struct polyline : utils::math::geometry::shape::details::polyline<polyline<const_vertices, ends>, ends>
			{
