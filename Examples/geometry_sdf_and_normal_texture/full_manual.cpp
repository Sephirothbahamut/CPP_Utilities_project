...
void geometry_sdf_and_normal_texture::full_manual() const noexcept
	...
	utils::math::geometry::shape::bezier<4> curve2
		{
		utils::math::vec2f{2.5f, 107.5625f},
		utils::math::vec2f{2.5f, 103.979172f},
		utils::math::vec2f{3.09375f, 100.84375f},
	...
	curve2.translate_self({128.f, 0.f});
	...
	/**/
		...
		gdist = utils::math::geometry::sdf::gradient_signed_distance::merge_absolute(gdist, curve .sdf(coords_f).gradient_signed_distance());
		gdist = utils::math::geometry::sdf::gradient_signed_distance::merge_absolute(gdist, curve2.sdf(coords_f).gradient_signed_distance());
