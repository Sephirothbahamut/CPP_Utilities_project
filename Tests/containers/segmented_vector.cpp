...
namespace Microsoft
	...
	namespace VisualStudio
		...
		namespace CppUnitTestFramework
			{
			template<> static std::wstring ToString<utils::beta::containers::segmented_vector<disney>::iterator> (const struct utils::beta::containers::segmented_vector<disney>::iterator& t)
				{
				std::wstringstream s;
				s << &(*t);
				return s.str();
				}
			template<> static std::wstring ToString<utils::beta::containers::segmented_vector<disney, 2>::iterator>(const struct utils::beta::containers::segmented_vector<disney, 2>::iterator& t)
				{
				std::wstringstream s;
				s << &(*t);
				return s.str();
				}
			template<> static std::wstring ToString<utils::beta::containers::segmented_vector<disney, 5>::iterator>(const struct utils::beta::containers::segmented_vector<disney, 5>::iterator& t)
				{
				std::wstringstream s;
				s << &(*t);
				return s.str();
				}
			template<> static std::wstring ToString<utils::beta::containers::segmented_vector<disney>::reverse_iterator>(const struct utils::beta::containers::segmented_vector<disney>::reverse_iterator& t)
				{
				std::wstringstream s;
				s << &(*t);
				return s.str();
				}
			template<> static std::wstring ToString<utils::beta::containers::segmented_vector<disney, 2>::reverse_iterator>(const struct utils::beta::containers::segmented_vector<disney, 2>::reverse_iterator& t)
				{
				std::wstringstream s;
				s << &(*t);
				return s.str();
				}
			template<> static std::wstring ToString<utils::beta::containers::segmented_vector<disney, 5>::reverse_iterator>(const struct utils::beta::containers::segmented_vector<disney, 5>::reverse_iterator& t)
				{
				std::wstringstream s;
				s << &(*t);
				return s.str();
	...
	TEST_CLASS(segmented_vector)
		...
		public:
			...
			TEST_METHOD(emplace_single_segment)
				{
				disney::reset();
				utils::beta::containers::segmented_vector<disney> a;
			...
			TEST_METHOD(emplace)
				{
				disney::reset();
				utils::beta::containers::segmented_vector<disney, 2> a;
			...
			TEST_METHOD(iterator_extra)
				...
				utils::beta::containers::segmented_vector<disney, 5> a;
