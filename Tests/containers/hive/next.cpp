...
namespace Tests
	...
	TEST_CLASS(next_as_handled_container)
			{
			public:
				TEST_METHOD(assignment)
					{
					utils::containers::hive::next<int> a;

					auto handle_1{a.emplace(1)};
					auto handle_2{a.emplace(2)};
					auto handle_3{a.emplace(3)};

					Assert::AreEqual(1, *handle_1);
					Assert::AreEqual(2, *handle_2);
					Assert::AreEqual(3, *handle_3);
					}
				TEST_METHOD(scramble)
					{
					utils::containers::hive::next<int> a;
